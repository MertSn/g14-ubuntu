...
- [Asus-Linux.org](https://asus-linux.org) — upstream project providing [`asusctl`](https://gitlab.com/asus-linux/asusctl) and [`supergfxctl`](https://gitlab.com/asus-linux/supergfxctl).
